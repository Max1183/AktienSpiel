                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <p>
                                    ...
                                    Preis: {formatCurrency(transaction.price)}<br />
                                    Aktienwert: {formatCurrency(transaction.amount * transaction.price)}<br />
                                    Gebühren: {formatCurrency(transaction.fee)}<br />
                                    Gesamtpreis: {formatCurrency(transaction.total_price)}<br />
                                    Datum: {formatDate(transaction.date)}<br />
                                </p>
                                <div className="mb-3">
